    ...
    >
      ...
      >
        ...
        <div className="lg:w-[50%] text-justify">
          <p>Sou estudante de Ciências & Tecnologia, focada no desenvolvimento de aplicações web. Estou sempre buscando entender o "porquê" das coisas e criar soluções práticas e eficientes. Em meus projetos, como simuladores e ferramentas interativas, exploro tecnologias como React, Firebase e JavaScript.

            Estou em constante evolução e aberta a novos desafios que me ajudem a crescer como programadora. Se você busca alguém com curiosidade, dedicação e capacidade de resolver problemas, podemos ter uma boa conversa.. Aqui estão algumas tecnologias com as quais estou familiarizada:</p>
